<template>
  <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="/newwoman">สินค้ามาใหม่</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/womanclothes">เสื้อผ้า</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/womansale">สินค้าลดราคา</a>
                        </li>
                    </ul>
                </div>
            </div>
      ...
      <header  class="container">
          <div id=sci5>
              <p></p><br>
                <li v-for="user in wclothes" :key="user.id">
...
<script>
import wclothes from "@/assets/wclothes.json"
export default {
    name:"womanclothes",
    data(){
        return{
