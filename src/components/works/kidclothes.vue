<template>
  <body>
      ...
      <header  class="container">
          <div id=sci5>
              <p></p><br>
                <li v-for="user in kclot2" :key="user.id">
...
import kclot from "@/assets/k_clothes.json"
export default {
data(){
        return{
            kclot2: kclot,
...
methods: {
    shoppingcart(){
        router.push(`/shopping/${this.pic}`);
        router.go();
        // this.num =  this.kclot2.id;
        // this.employeeInfo.push(this.kclot2[this.num]);
